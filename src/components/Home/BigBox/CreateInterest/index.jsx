...
function CreateInterest() {
    ...
    return ( <div className="py-[20px] px-[10px]">
        ...
        <div>
            <button ref={buttonRef} onClick={pushInterest} className="bg-gradient-to-r from-[#07D5DF] to-[#F408FE] w-full text-xl italic rounded-full text-white disabled:bg-gradient-to-r disabled:from-[#DDD] disabled:to-[#DDD] disabled:cursor-not-allowed hover:bg-black px-4 py-2 flex justify-center"><span>Tạo</span></button>
        </div>
    </div> );
}
