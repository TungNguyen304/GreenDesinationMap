...
function NotFound() {
  ...
  return (
    <div className="backgoundFullScreen">
      ...
      <div className="error">
        ...
        <Link to='/' className="error__button error__button--active">HOME USER</Link>
        <Link to='/host' className="error__button inline-block">HOME SUPPLIER</Link>
      </div>
